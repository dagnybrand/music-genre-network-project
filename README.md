...
The classification accuracy is tested at the bottom of (Semester_Project.ipynb). The classification accuracy on the validation data set is 59.667%. The classification accuracy on the training data set is 85.122%.
